...
import { HiMail, HiLockClosed, HiUser, HiUserGroup, HiSparkles, HiExclamationCircle, HiEye, HiEyeOff, HiArrowRight, HiCheckCircle } from 'react-icons/hi';
      ...
      >
        ...
        >
          ...
          >
            ...
            <h1 className="register-title">
              <span className="title-gradient">Create New Employee</span>
            </h1>
          </motion.div>
          <p className="register-subtitle">Add a new employee to the system</p>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <div className="input-group">
            ...
            <small className="input-hint">Select the employee's role in the system</small>
          </div>
          ...
          {formData.role === 'member' && (
            <div className="input-group">
              ...
              <small className="input-hint">Specify the employee's specific role (optional)</small>
            </div>
          )}
